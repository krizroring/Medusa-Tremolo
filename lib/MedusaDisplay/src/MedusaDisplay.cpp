...
0b0000000100000000, // `
0b0100000011110111, // A.
0b0101001010001111, // B.
0b0100000000111001, // C.
0b0101001000001111, // D.
0b0100000011111001, // E.
0b0100000001110001, // F.
0b0100000010111101, // G.
0b0100000011110110, // H.
0b0101001000000000, // I.
0b0100000000011110, // J.
0b0110010001110000, // K.
0b0100000000111000, // L.
0b0100010100110110, // M.
0b0110000100110110, // N.
0b0100000000111111, // O.
0b0100000011110011, // P.
0b0110000000111111, // Q.
0b0110000011110011, // R.
0b0100000011101101, // S.
0b0101001000000001, // T.
0b0100000000111110, // U.
0b0100110000110000, // V.
0b0110100000110110, // W.
0b0110110100000000, // X.
0b0101010100000000, // Y.
0b0100110000001001, // Z.
0b0000100101001001, // {
0b0001001000000000, // |
0b0010010010001001, // }
0b0000010100100000, // ~
...
void MedusaDisplay::writeBack() {
    display_buffer[0] = 0b0001001010001111; //B
    display_buffer[1] = 0b0000000011110111; //A
    display_buffer[2] = 0b0000000000111001; //C
    display_buffer[3] = 0b0010010001110000; //K

    flushBuffer();
}

void MedusaDisplay::writeVersion(unsigned int _major, unsigned int _minor) {
